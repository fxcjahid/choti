...
class MenuItem extends Model
{
    ...
    /**
     * Determine if the menu item type is product category.
     *
     * @return bool
     */
    ...
    /**
     * Determine if the menu item type is blog category.
     *
     * @return bool
     */
    public function isBlogCategoryType()
    {
    ...
    public function url()
    {
        ...
        if ($this->isBlogCategoryType()) {
            return optional($this->blog)->url();
        }
