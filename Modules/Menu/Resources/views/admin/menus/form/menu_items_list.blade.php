        ...
        <li class="dd-item" data-id="{{ $menuItem->id }}">
            @if (!$menuItem->is_root)
                <div class="menu-item-actions btn-group" role="group">
                    <a hreflang="{{ locale() }}"
                        href="{{ route('admin.menus.items.edit', [$menu->id, $menuItem->id]) }}"
                        class="btn edit-menu-item ">
                        <i class="fa fa-pencil"></i>
                    </a>

                    <button type="button" class="btn delete-menu-item"
                        data-action="{{ route('admin.menus.items.destroy', [$menu->id, $menuItem->id]) }}">
