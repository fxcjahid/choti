...
@section('content')
    <header class="sticky top-0 z-40 bg-white dark:bg-gray-800">
        <div class="m-auto min-h-[65px] border-b border-solid border-gray-200">
            <div
                 class="inline-flex h-full min-h-[inherit] w-full items-center justify-between">
                <!-- Left Side Bar -->
                <div class=""
                     areia-lable="navigation">
                ...
                <div class="inline-flex items-center gap-3">
                    ...
                    <div
                        ...
                        <div class="flex items-center">
                            <span
                                  class="inline-flex h-7 w-7 items-center justify-center transition-colors">
    ...
    <main class="inline-flex w-full"
        ...
        <create-post v-slot="vm"
                    ...
                    <form @submit.prevent>
                        ...
                        <div class="-mx-4 mt-5 flex flex-wrap">
                            <div class="w-full px-4">
                                ...
                                <Cretate-Post-Editor class="rounded-md border"
                                            ...
                                            <div class="hs-dropdown relative inline-flex"
                                                ...
                                                <div class="hs-dropdown-menu duration z-10 mt-2 hidden min-w-[13rem] max-w-[250px] rounded-lg border bg-white p-2 opacity-0 shadow-md transition-[opacity,margin] hs-dropdown-open:opacity-100 dark:border dark:border-gray-700 dark:bg-gray-800"
                                                    ...
                                                    <div
                                                        ...
                                                        <label for="hs-dropdown-item-radio-password"
                                                               class="ml-3.5">
                                                            <span
                                                                  class="block text-sm font-semibold text-gray-800 dark:text-gray-300">
                                                                Password Protected
                        ...
                        <div class="my-2"
                            ...
                            <div class="mt-2"
                                ...
                                <div role="option"
                                    ...
                                    <div class="flex items-center justify-between gap-2">
                                        <div role="item"
                                             class="overflow-anywhere font-light text-slate-900">
                                            {{ url('/') }}/<span
                                                  v-text="vm.getFirstCategory"
                                                  class="overflow-anywhere"></span>/<span
                                                  v-text="vm.getPostTitle"
                                        ...
                                        <div role="item"
                                            ...
                                            <div class="flex">
                                                <input type="radio"
                                                       ...
                                                       id="hs-default-radio"
                                                       v-model="vm.form.permalink.custom"
                                                       :value="false"
                                                       checked>
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <input v-if="vm.form.permalink.custom"
                                                       v-model="vm.form.permalink.link"
                                                       type="text"
                                                       name="hs-default-radio"
                                ...
                                <div role="option"
                                    ...
                                    <div class="flex items-center justify-between gap-2">
                                        <div class="flex w-full items-center justify-center"
                                            ...
                                            <div v-on:click="vm.open"
                                                 role="select image"
                                                 v-if="!vm.getPostThumbnail"
                                            ...
                                            <div class="placholder-image"
                                                 v-if="vm.getPostThumbnail">
                                                <div
                                                     class="h-64 rounded-lg border-2 border-dashed border-gray-300 bg-gray-50">
                                                    <img class="h-full w-auto rounded-lg"
                                                         :src="vm.getPostThumbnail.path">
                                                </div>
            ...
            <file-manager v-if="vm.openModal"
                          @open="vm.open"
                          @close="vm.close"
                          @select="vm.select"></file-manager>
