...
@section('content')
    ...
    <main class="inline-flex w-full"
        ...
        <div role="catogories"
            ...
            <create-tag v-slot="vm">
                <div v-if="!vm.isEditTag">
                    <div
                    ...
                    <div class="flex gap-7">
                        ...
                        <div class="sticky top-[70px] h-[450px] w-2/5 transition-all">
                            <div class="flex flex-col">
                                <div class="-m-1.5 overflow-x-auto">
                                    <div class="inline-block min-w-full p-1.5 align-middle">
                                        <div
                    ...
                    <div
                        ...
                        <form @submit.prevent="vm.update"
                            ...
                            <div class="mb-4 text-xl font-semibold capitalize text-gray-600">
                                Edit Tag: <span v-text="vm.form.name"></span>
                            </div>
                            <div class="mb-1">
                                <label for="cat-name"
                                       class="mb-2 block text-sm font-medium dark:text-white">
