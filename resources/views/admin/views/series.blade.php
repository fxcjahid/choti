    ...
    <main class="inline-flex w-full" areia-label="content">
        ...
        <div role="catogories" class="w-full py-5 px-5">
            <create-series v-slot="vm">
                                ...
                                <div class="-m-1.5 overflow-x-auto">
                                    <div class="inline-block min-w-full p-1.5 align-middle">
                                        <div
                                            ...
                                            <form @submit.prevent="vm.store" class="py-3 px-4" autocomplete="off">
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="cat-name" v-model="vm.form.name"
                                                        v-on:keyup="vm.updateSlug" v-on:keydown="vm.updateSlug"
                                                ...
                                                <div class="my-2">
                                                    ...
                                                    <input type="text" id="cat-slug" v-model="vm.form.slug"
                                                        v-on:change="vm.validationSlug" name="slug" autocomplete="off"
                                                        class="block w-full rounded-md border-gray-200 py-2 px-4 text-base outline-none dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400" />
                                                </div>
                                                <div class="my-2">
                                                    ...
                                                    <textarea id="cat-description" v-model="vm.form.description" name="description"
                                                ...
                                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                                    ...
                                                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                                        ...
                                                        <tr v-for="item in vm.tables"
                                                            ...
                                                            <td v-text="item.slug" title="view Series post"
                                                            ...
                                                            <td v-text="item.description" :title="item.description"
                ...
                <div v-else>
                    <div class="divide-y divide-gray-200 dark:divide-gray-700 dark:border-gray-700">
                        <form @submit.prevent="vm.update" class="py-3 px-4" autocomplete="off">
                            <div class="mb-4 text-xl font-semibold capitalize text-gray-600">
                                Edit series: <span v-text="vm.form.name"></span>
                            </div>
                            <div class="mb-1">
                                <label for="cat-name" class="mb-2 block text-sm font-medium dark:text-white">
                                    Name
                                </label>
                                <input type="text" id="cat-name" v-model="vm.form.name" v-on:keyup="vm.updateSlug"
                                    v-on:keydown="vm.updateSlug" name="name" autocomplete="off"
                            ...
                            <div class="my-2">
                                <label for="cat-slug" class="mb-2 block text-sm font-medium dark:text-white">
                                    Slug
                                </label>
                                <input type="text" id="cat-slug" v-model="vm.form.slug"
                                    v-on:change="vm.validationSlug" name="slug" autocomplete="off"
                            ...
                            <div class="my-2">
                                <label for="parent-cat-dropdown" class="mb-2 block text-sm font-medium dark:text-white">
                                    Parent series
                                </label>
                                <select name="parent_id"
                                    class="block w-auto min-w-[250px] rounded-md border-gray-200 py-2 px-4 text-base outline-none dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400"
                                    id="parent-cat-dropdown" autocomplete="off" disabled>
                                    <option selected>None</option>
                                </select>
                            </div>
                            <div class="my-2">
                                <label for="cat-description" class="mb-2 block text-base font-medium dark:text-white">
                                    Description
                                </label>
                                <textarea id="cat-description" v-model="vm.form.description" name="description"
                            ...
                            <div class="mt-4 flex">
                                <input type="checkbox"
                                    ...
                                    id="hs-default-checkbox" v-model="vm.form.is_active" name="is_active">
                                <label for="hs-default-checkbox" class="ml-3 text-base font-medium dark:text-gray-400">
                                    Enable the series
                                </label>
                            </div>
                            ...
                            <div class="mt-8 text-left">
                                ...
                                <button type="button" @click="vm.editClose()"
