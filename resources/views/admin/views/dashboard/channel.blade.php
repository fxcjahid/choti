<div
    class="w-5/12 p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
    <div class="flex items-center justify-between pb-4 mb-4 border-b border-gray-200 dark:border-gray-700">
        <div>
            ...
            <span class="text-2xl font-bold leading-none text-slate-900 sm:text-3xl dark:text-white">Desktop</span>
        </div>
    </div>
    ...
    <div class="flex items-center justify-between pt-4 lg:justify-evenly sm:pt-6">
        <div>
            ...
            <h3 class="text-gray-500 font-medium dark:text-gray-400">Desktop</h3>
        ...
        <div>
            ...
            <h3 class="text-gray-500 font-medium dark:text-gray-400">Phone</h3>
            <h4 class="text-xl font-bold dark:text-white">
                94k
            </h4>
            <p class="flex items-center text-sm text-gray-500 dark:text-gray-400">
        ...
        <div>
            ...
            <h3 class="text-gray-500 font-medium dark:text-gray-400">Tablet</h3>
            <h4 class="text-xl font-bold dark:text-white">
                16k
            </h4>
            <p class="flex items-center text-sm text-gray-500 dark:text-gray-400">
