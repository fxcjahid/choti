                                ...
                                <article
                                    ...
                                    <div
                                        ...
                                        <a href="{{ route('admin.create.get', $post->id) }}">
                                            @php
                                                $thumbnail = !empty(isset($post->thumbnail[0]->path)) ? $post->thumbnail[0]->path : asset('/assets/public/img/thumbnail-placeholder.png');
                                            @endphp
                                    ...
                                    <div class="flex w-full flex-wrap">
                                        <div class="flex h-full flex-col py-6 px-0">
                                            ...
                                            <div class="mt-5 flex items-center sm:mt-auto">
                                                <div
                                                     class="text-sm capitalize text-gray-500 dark:text-gray-500">
                                                    {{ $post->status }}
                                                </div>

                                                <div class="hs-tooltip -mt-1 inline-block">
                                                    <div
                                                         class="hs-tooltip-toggle inline-flex">
                                                        <div
                                                             class="before-point relative ml-4 flex items-center pl-[20px] text-sm text-gray-500 dark:text-gray-500">
                                                            {{ $post->created_at->format('d M, Y') }}
                                                        </div>
                                                        <span class="hs-tooltip-content invisible absolute z-10 inline-block rounded-md bg-gray-900 py-1 px-2 text-xs font-medium text-white opacity-0 shadow-sm transition-opacity hs-tooltip-shown:visible hs-tooltip-shown:opacity-100 dark:bg-slate-700"
                                                              role="tooltip">
                                    ...
                                    <div class="tools flex flex-wrap">
                                        <div
                                             class="flex h-full min-w-[150px] flex-wrap py-6 px-2 transition-all">

                                            <!-- tools -->
                                            <div
                                                 class="post-tools-hover m-auto w-full transition">
                                                <div
                                                     class="flex justify-center gap-5 rounded-full p-2 shadow">


                                                    <div
                                                         class="hs-tooltip inline-block h-8 w-8 cursor-pointer p-1 text-gray-500">
                                                        @php
                                                            $category = empty($post->category[0]->name) ? 'draft' : $post->category[0]->slug;
                                                            $slug = route('post.show', ['slug' => $post->slug, 'category' => $category]);
                                                        @endphp
                                                        <a href="{{ $slug }}"
                                                           target="_blank"
                                            ...
                                            <!-- statics -->
                                            <div
                                                 class="mt-auto mr-4 flex w-full flex-wrap justify-end gap-4">
                                                <div class="flex">
