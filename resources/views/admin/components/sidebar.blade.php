<div class="sidebar hover:overflow-y-auto"
            ...
            <ul class="space-y-2">
                <li>
                    ...
                    <ul id="dropdown-pages"
                        class="sub-list hidden space-y-2 py-2">
                        <li>
                            <a href="{{ route('admin.dashboard', ['orderBy' => 'desc']) }}"
                               class="sub-item">
                                All Post
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.category') }}"
                               class="sub-item">Categories</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.tags.index') }}"
                               class="sub-item">Tags</a>
                        </li>
                    </ul>
                </li>
                <li>
