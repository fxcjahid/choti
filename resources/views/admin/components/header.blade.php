<header class="sticky top-0 z-50 bg-white dark:bg-gray-800">
    <div class="m-auto min-h-[65px] border-b border-solid border-gray-200">
        <div
             class="absolute inline-flex h-full min-h-[inherit] w-full items-center justify-between">
            <!-- Left Side Bar -->
            ...
            <create-search v-slot="vm">
                <div class="relative w-auto">
                    <div class="lg:w-[650px]">
                        <div class="relative">
                            <input type="text"
                                   v-on:input="vm.startSearching"
                                   v-on:blur="vm.cancelSearch"
                    ...
                    {{-- Query Results --}}
                    <div v-if="vm.searckResults"
                         :class="{ '!block': vm.searckResults.post }"
                        ...
                        <div v-for="item in vm.searckResults.post"
                            ...
                            <a tabindex="1"
                               v-on:click="vm.openPost(item.id)"
                               v-html="vm.matchingKeyword(item.name)"
